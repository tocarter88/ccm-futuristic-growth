  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "rgb-glow": "rgb-glow 4s ease-in-out infinite",
      ...
      backgroundImage: {
        ...
        'gradient-glow': 'linear-gradient(135deg, hsl(var(--glow-primary) / 0.3), hsl(var(--glow-secondary) / 0.3))',
        'gradient-rgb': 'linear-gradient(90deg, #3b82f6, #9333ea, #ec4899, #3b82f6)',
      },
      boxShadow: {
        'glow': '0 0 40px hsl(var(--glow-primary) / 0.3)',
        'glow-lg': '0 0 60px hsl(var(--glow-primary) / 0.4)',
        'rgb': '0 0 20px rgba(59, 130, 246, 0.5), 0 0 40px rgba(59, 130, 246, 0.3)',
      },
    },
  },
